...
graduate-level research. For my first mini-project, I worked on comparing the sample efficiciency<sup>[1](#footnote1)</sup> of model-based and model-free methods in 
